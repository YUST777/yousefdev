...
export default function ProjectsPage() {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: "Tools",
      tags: ["Tools", "Bots"],
      description: "Real-time Telegram gift tracking",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            {filteredProjects.map((project) => (
              <BentoTilt
                ...
                onClick={() => {
                  setOpenDrawer(project.title.toLowerCase().replace(/\s+/g, ''))
                }}
              >
                          ...
                          openDrawer === 'retroos' ? 'retroOS - React OS Simulation' :
                            openDrawer === 'icpchue' ? 'ICPCHUE - Hardened Judge Platform' :
                              openDrawer === 'yousefdev' ? 'yousefdev - Portfolio' :
                                openDrawer === 'giftscharts' ? 'Gifts Charts - Telegram Bot' : ''}
                  </h3>
                </div>
                <button
                  onClick={() => setOpenDrawer(null)}
                ...
                {openDrawer === 'giftscharts' && (
                  <>
                    ...
                    <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                      ...
                      <p className="text-sm text-gray-300 leading-relaxed">
                        Telegram's digital asset market is moving fast. <strong className="text-white">Gifts Charts</strong> bridges the gap between chaos and clarity by providing real-time price tracking for Stickers and unique Gifts. It empowers traders and collectors with instant data, helping them make informed decisions on the fly.
                      </p>
                    </div>
                      ...
                      <ul className="space-y-4 text-sm text-gray-300">
                        ...
                        <li className="flex gap-3">
                          ...
                          <div>
                            ...
                            Instead of boring text lists, the bot generates <strong className="text-white">beautiful, shareable price cards</strong> on demand using a custom image processing engine.
                          </div>
                        </li>
                        <li className="flex gap-3">
                          ...
                          <div>
                            ...
                            Includes a fully functional <strong>Premium Subscription</strong> system. Users can pay via Telegram Stars to unlock exclusive signals and ad-free experiences.
                          </div>
                        </li>
                      </ul>
                    </div>
